...
<body class="bg-gray-100 flex flex-col min-h-screen">
    <div class="flex flex-1">
        ...
        <div class="w-5/6 ml-auto p-8">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h1 class="text-3xl font-bold text-purple-600 mb-6 flex items-center">
                    <i class="fa-solid fa-stethoscope mr-3"></i>
                    Peta Sebaran Klinik di Bandar Lampung
                </h1>
                ...
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <div id="total-klinik" class="text-gray-700 font-semibold">
                        Total Klinik: <span id="klinik-count">0</span>
                    </div>
                </div>
                ...
                <!-- Tabel Klinik -->
                <div class="mt-6">
                    <h2 class="text-2xl font-semibold mb-4 text-purple-600">Daftar Klinik</h2>
                    <div class="overflow-x-auto">
                        <table class="w-full bg-white border" id="klinik-table">
                            <thead class="bg-purple-100">
                                <tr>
                                    <th class="p-3 text-left">No</th>
                                    <th class="p-3 text-left">Nama Klinik</th>
    ...
    <script>
        ...
        async function fetchKlinikData() {
            try {
                const response = await fetch('api_klinik.php?action=all');
                const result = await response.json();
