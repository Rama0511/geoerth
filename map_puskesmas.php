...
<head>
    ...
    <title>GeoEarth - Peta Puskesmas</title>
...
<body class="bg-gray-100 flex flex-col min-h-screen">
        ...
        <div class="w-5/6 ml-auto p-8">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h1 class="text-3xl font-bold text-green-600 mb-6 flex items-center">
                    ...
                    Peta Sebaran Puskesmas di Provinsi Lampung
                </h1>
                ...
                <div class="mb-6 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <button id="filter-btn" class="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700">
                            Filter
                        </button>
                    </div>
                    <div id="total-klinik" class="text-gray-700 font-semibold">
                        Total Puskesmas: <span id="klinik-count">0</span>
                    </div>
                </div>
                ...
                <!-- Tabel Klinik -->
                <div class="mt-6">
                    <h2 class="text-2xl font-semibold mb-4 text-green-600">Daftar Puskesmas</h2>
                    <div class="overflow-x-auto">
                        <table class="w-full bg-white border" id="klinik-table">
                            <thead class="bg-green-100">
                                <tr>
                                    <th class="p-3 text-left">No</th>
                                    <th class="p-3 text-left">Nama Puskesmas</th>
    ...
    <script>
                    ...
                    <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="p-3">
                            <button onclick="zoomToKlinik(${klinik.latitude}, ${klinik.longitude})" 
                                    class="bg-green-500 text-white px-3 py-1 rounded hover:bg-purple-600">
                                Lokasi
                            </button>
                        </td>
                    </tr>
        ...
        async function fetchKlinikData() {
            try {
                const response = await fetch('api_puskesmas.php?action=all');
                const result = await response.json();
